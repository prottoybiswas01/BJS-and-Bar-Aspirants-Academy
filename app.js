...
function syncVideoPlaybackSupport() {
  ...
  if (dom.startVideoBtn) {
    dom.startVideoBtn.textContent = "Start Class";
  }
...
function openVideo(videoConfig, title) {
  ...
  const playbackEnvironment = syncVideoPlaybackSupport();
  ...
  if (dom.videoStatusText && playbackEnvironment.prefersExternalPlayback) {
    dom.videoStatusText.textContent = "Use Chrome browser if this player is blocked";
  }
